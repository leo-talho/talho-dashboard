...
export default function Dashboard() {
  ...
  // UPDATE THESE CREDENTIALS - share password with team via secure channel
  const validUsers = {
  ...
  // UPDATE THESE VALUES monthly from Analytics.xlsx
  // Data structure: current month/period vs previous
  const kpiData = {
    YTD: {
          ...
          <div style={{ background: '#ffffff', border: '1px solid #e1e0d9', borderRadius: '8px', padding: '2rem' }}>
            ...
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div>
                ...
                <input type="email" value={user} onChange={(e) => setUser(e.target.value)} placeholder="leo@talho.com.br" style={{ width: '100%', padding: '0.75rem', border: '1px solid #e1e0d9', borderRadius: '6px', fontSize: '14px', fontFamily: 'inherit' }} />
              </div>
              <div>
                <label style={{ fontSize: '13px', color: '#52514e', display: 'block', marginBottom: '0.5rem' }}>Senha</label>
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••" style={{ width: '100%', padding: '0.75rem', border: '1px solid #e1e0d9', borderRadius: '6px', fontSize: '14px', fontFamily: 'inherit' }} />
              </div>
  ...
  return (
    <div style={{ background: '#ffffff', border: '1px solid #e1e0d9', borderRadius: '6px', padding: '1rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <span style={{ fontSize: '12px', fontWeight: '500', color: isPositive ? '#ffffff' : '#ffffff', background: isPositive ? '#008300' : '#d03b3b', padding: '2px 6px', borderRadius: '4px' }}>
